...
var yourTargetEmail,
    yourSourceEmail = 'example@crowdin.com' // Set your main email in next format 'example@crowdin.com'
...
var translation = crowdin.translation,
    patternForSourceMail,
    patternForTargetMail
...
var sourceMatch = source.match(patternForSourceMail),
    translationMatch = translation.match(patternForTargetMail)
